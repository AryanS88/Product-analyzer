...
class Register:
    def __init__(self, root):
        ...
        title = Label( frame1, text = "Welcome to our Family",font=("Montserrat",20,"bold"),bg="#CAF0F8",fg="green").place(x= 50,y=30)
        
        # Row 1
        
        first_Name = Label(frame1,text = "First Name :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 50,y=100)
        self.txt_first_Name = Entry(frame1,  font=("Montserrat",15),bg="#90e0ef")
        self.txt_first_Name.place(x= 50,y=130, width=250)
        
        last_Name = Label(frame1,text = "Last Name :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 450,y=100)
        self.txt_last_Name = Entry(frame1,  font=("Montserrat",15),bg="#90e0ef")
        self.txt_last_Name.place(x= 450,y=130, width=250)
        
        # Row 2
        
        contact_num = Label(frame1,text = "Phone Number :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 50,y=160)
        self.txt_contact_num = Entry(frame1,  font=("Montserrat",15),bg="#90e0ef")
        self.txt_contact_num.place(x= 50,y=190, width=250)
        
        email_id = Label( frame1, text = "Email :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 450,y=160)
        self.txt_email_id = Entry(frame1,  font=("Montserrat",15),bg="#90e0ef")
        self.txt_email_id.place(x= 450,y=190, width=250)
        
        # Row 3
        
        question = Label( frame1, text = "Security Question :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 50,y=220)
        
        self.cmb_question = ttk.Combobox(frame1,  font=("Montserrat",13),state="readonly",justify="center")
        self.cmb_question['values'] =("Choose One!","Your Pet Name","Your first Crush","Your Best Friends","Your Birth Place")
        self.cmb_question.place(x= 50,y=250, width=250)
        self.cmb_question.current(0)
        
        answer = Label( frame1, text = "Answer :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 450,y=220)
        self.txt_answer = Entry(frame1,  font=("Montserrat",15),bg="#90e0ef")
        self.txt_answer.place(x= 450,y=250, width=250)
        
        # Row 4
        
        password = Label( frame1, text = "Password :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 50,y=280)
        self.txt_password = Entry(frame1,  font=("Montserrat",15),bg="#90e0ef")
        self.txt_password.place(x= 50,y=310, width=250)
        
        c_password = Label( frame1, text = "Confirm Password :",font=("Montserrat",15,"bold"),bg="#CAF0F8",fg="#1d3557").place(x= 450,y=280)
        self.txt_c_password = Entry( frame1, font=("Montserrat",15),bg="#90e0ef")
        self.txt_c_password.place(x= 450,y=310, width=250)
        
        # T & C 
        self.var_chk = IntVar()
        chk = Checkbutton(frame1, text="I Agree to the Terms and Conditions of your WebApp", variable=self.var_chk,onvalue=1, offvalue=0 ,bg="#CAF0F8", font=("Montserrat",10)).place(x=50,y=340)
        
        self.btn_image = ImageTk.PhotoImage(file="Images/signup.png",width="50",height="30")
        btn =Button( frame1,image = self.btn_image,bd=0,cursor="hand2",bg="#CAF0F8",command=self.register_data).place(x=490,y=340)
        
        self.btn1_image = ImageTk.PhotoImage(file="Images/login.png",width="50",height="30")
        btn =Button(frame1, image = self.btn1_image,bd=0,cursor="hand2",bg="#CAF0F8",command=self.login_window).place(x=570,y=340)
